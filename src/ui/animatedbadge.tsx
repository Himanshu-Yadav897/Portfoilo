...
// const FlowerIcon = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" width="20" height="20" className="coolshapes flower-1 opacity-80 dark:opacity-100">
...
//     </defs>
//   </svg>;
export const AnimatedBadge = ({ text, icon, borderColor, className = "" }) => {
...
// export default function AnimatedBadgeView() {
//   const animatedGradientColors = [
//     "via-white",
//     "via-sky-500",
//     "via-emerald-500",
