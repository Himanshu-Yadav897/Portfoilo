...
const Contact = () => {
  const contactLinks = [
    {
      ...
      href: "https://mail.google.com/mail/?view=cm&fs=1&to=hy897433@gmail.com",
      delay: 0.3,
    },
    {
  ...
  return (
    <div
      className="mx-auto w-full min-h-[60vh] px-4 sm:px-6 lg:px-8"
      id="contact"
    >
      <motion.div
      ...
      >
        ...
        >
          Got a project or just want to chat? Feel free to reach out through any
